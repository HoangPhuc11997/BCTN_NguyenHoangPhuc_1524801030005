...
<head>
  ...
  <link href="/WebPHP/public/frontend/css/page.css" rel="stylesheet">
...
<body id="page-top">
      ...
      <li class="nav-item dropdown no-arrow">
        ...
        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
          <?php if(isset($_SESSION['admin_name'])) : ?>
            <a class="dropdown-item" href="#"><strong><?php echo $_SESSION['admin_name'] ?></strong></a>
          <?php endif ; ?>         
          <div class="dropdown-divider"></div>
  ...
  <div id="wrapper">
    ...
    <ul class="sidebar navbar-nav">
      <li class="nav-item <?php echo isset($open) && $open == 'info' ? 'active' : '' ?>">
      ...
      <li class="nav-item <?php echo isset($open) && $open == 'customer' ? 'active' : '' ?>">
        <a class="nav-link" href="<?php echo modules("customer") ?>">
          <i class="fas fa-fw fa-chart-area"></i>
