...
$sql = "SELECT product.*,catalog.name as namecate
        ...
        where product.name LIKE '%$search%' OR catalog.name LIKE '%$search%' ";

  $product = $db->fetchJone('product',$sql,$p,24,true);
...
<div class="container-fluid">
				<div class="inner-sec-shop px-lg-4 px-3">
					<h3 class="tittle-w3layouts my-lg-4 mt-3">Kết quả tìm kiếm cho <?php echo $search ?> </h3>
					<div class="row">
						<!-- product left -->
							...
							<div class="wrapper_top_shop">
					            ...
					            <ul class="pagination">
					              <?php for ($i=1; $i <= $sotrang; $i++) : ?>
					                <li class="page-link"><a href="<?php $path ?>?id=<?php echo $id ?> && p=<?php echo $i ?>"><?php echo $i ?></a></li>
					              <?php endfor ?>
					            </ul>
					          </nav>
							</div>
